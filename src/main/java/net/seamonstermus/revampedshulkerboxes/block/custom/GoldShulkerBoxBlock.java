...
public class GoldShulkerBoxBlock extends BlockWithEntity {
	...
	public GoldShulkerBoxBlock(@Nullable DyeColor color,Settings settings) {
        super(settings);
	...
	public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
		return new GoldShulkerBoxBlockEntity(this.color, pos, state);
	}
	...
	public static DyeColor getColor(Block block) {
		return block instanceof GoldShulkerBoxBlock ? ((GoldShulkerBoxBlock)block).getColor() : null;
	}
